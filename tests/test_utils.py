...
def test_get_audio_numpy_resample():
    ...
    wavs = [
        wavs_dir + "/+90deg_010_OCT3D_1_FL.wav",
        wavs_dir + "/+90deg_011_OCT3D_2_FR.wav",
        wavs_dir + "/+90deg_012_OCT3D_3_FC.wav",
        wavs_dir + "/+90deg_013_OCT3D_4_RL.wav",
        wavs_dir + "/+90deg_014_OCT3D_5_RR.wav",
        wavs_dir + "/+90deg_015_OCT3D_6_FLh_1m.wav",
        wavs_dir + "/+90deg_016_OCT3D_7_FRh_1m.wav",
        wavs_dir + "/+90deg_017_OCT3D_8_RLh_1m.wav",
        wavs_dir + "/+90deg_018_OCT3D_9_RRh_1m.wav",
    ]
    wavs.sort()
    B = np.array([librosa.load(w, 24000, mono=False)[0] for w in wavs])
...
def test_get_audio_numpy_a2b():
    ...
    B = np.array([librosa.load(w, sr=48000, mono=False)[0] for w in wavs])
    ...
    B = librosa.load(
        wavs_dir + "/+90deg_065_Eigenmike_Raw_32ch.wav", sr=48000, mono=False
    )[0]
