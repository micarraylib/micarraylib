...
def test_tau2021sse_nigens_helper():
    ...
    assert isinstance(a, micarraylib.datasets.tau2021sse_nigens_loader.tau2021sse_nigens)
...
def test_tau2020sse_nigens_helper():
    ...
    assert isinstance(a, micarraylib.datasets.tau2020sse_nigens_loader.tau2020sse_nigens)
