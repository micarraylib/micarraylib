...
def tau2021sse_nigens(download=True, data_home=None):
    """
    helper to load the tau2021sse nigens Dataset class
    """

    return tau2021sse_nigens_loader.tau2021sse_nigens(download=download, data_home=data_home)
...
class tau2021sse_nigens_(Dataset):
    """
...
class tau2020sse_nigens(Dataset):
    """
    The tau2020sse Dataset class
    ...
    """
    def __init__(self, name='tau2020sse_nigens', fs=24000, array_format=tausse_array_format, capsule_coords=tausse_capsule_coords, download=True, data_home=None):
        super().__init__(name, fs, array_format, capsule_coords, download, data_home)
...
class tau2019sse(Dataset):
    ...
    Attributes:
        ...
        clips_list (list): a list with the different
            ...
            of the microphone arrays.
    """
    def __init__(self, name='tau2019sse', fs=24000, array_format=tausse_array_format, capsule_coords=tausse_capsule_coords, download=True, data_home=None):
        super().__init__(name, fs, array_format, capsule_coords, download, data_home)
