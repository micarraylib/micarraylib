...
def test_deg2rad():
    ...
    coords_dict_deg = {'a':[256,45,9]}
    coords_dict_rad = {'a':[256*(math.pi/180),45*(math.pi/180),9]}
...
def test_polar2cart():
    ...
    coords_dict_cart = {'a':
        [
            9*math.sin(256*piover180)*math.cos(45*piover180),
            9*math.sin(256*piover180)*math.sin(45*piover180),
            9*math.cos(256*piover180),
        ]
    }
